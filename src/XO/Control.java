...
public class Control {
    ...
    public void run() {
        ...
        Stack<Move> undoStack = game.getUndoStack();
        Stack<Move> redoStack = game.getRedoStack();
        ...
        while (!game.isFull()) {
            ...
            if (option == 1) { // nhập tọa độ
                ...
                if (redoStack.isEmpty()) {
                    ...
                    undoStack.push(new Move(move.getRow(), move.getCol(), move.getOldValue(), move.getNewValue()));
                    view.showMessage("Đã làm lại!");
                    view.displayBoard(game.getBoard());
                }
            } else if (option == 4) { // thoát
